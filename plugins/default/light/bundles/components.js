...
var LightUpdater = (function () {
    function LightUpdater(client, light, config) {
        ...
        this.client = client;
        this.light = light;
        this.onLightResourceReceived = function (resourceId, resource) {
            _this.lightSettings = resource;
            _this.updateLightShadowMap();
        };
        this.onLightResourceEdited = function (resourceId, command, propertyName) {
    ...
    LightUpdater.prototype.updateLightShadowMap = function () {
